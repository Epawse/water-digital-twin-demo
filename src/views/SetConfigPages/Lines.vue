          ...
          <template v-slot:content>
            <div class="lines_con">
              <template v-if="type==='FlyLines'">
                <span class='c_title'>飞线数：{{random}} 条 <el-button @click="makeLines" size="small" style="float: right;margin-top: -6px;">重新生成</el-button></span>
              ...
              <template v-if="type!=='RoadPic'">
                ...
                <el-color-picker v-model="color" size="small" class="color-pick-s" @active-change="change_color"></el-color-picker><br><br>
              ...
              <el-button @click="save" size="small">保存当前设置</el-button>
            </div>
          </template>
        </PannelBox>
      </div>
