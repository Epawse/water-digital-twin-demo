        ...
        <PannelBox>
          <template v-slot:content>
            <div class="effect_con">
              ...
              <el-select-v2 v-model="selEffect" size="small" placeholder="效果类型" @change="effect_selEffect_change" :options="effectsList">
              </el-select-v2><br><br>
              ...
              <el-color-picker v-model="color" show-alpha size="small" class="color-pick-s" @active-change="change_color"></el-color-picker><br><br>
