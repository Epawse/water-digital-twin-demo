...
- 已创建数据库与用户（当前 `.env` 示例使用 `gisuser/gisdb`，密码 `primeb350m`）
...
```
DATABASE_URL=postgresql+asyncpg://gisuser:primeb350m@localhost:5432/gisdb
DATABASE_URL_SYNC=postgresql+psycopg2://gisuser:primeb350m@localhost:5432/gisdb
API_PREFIX=/api
DEBUG=true
